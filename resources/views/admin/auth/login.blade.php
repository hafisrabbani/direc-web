...
<head>
    ...
    <title>Panoptes | User Login</title>
            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo" style="margin-bottom: 1rem;">
                        <a href="/"><img src="{{ asset('dist/assets/img/logo.png') }}" alt="Logo"
                                class="img-fluid my-logo"></a>
                    </div>
                    <h1 class="auth-title">Log in.</h1>
                    <p class="display-6 mb-5">Login untuk melanjutkan</p>

                    <form action="{{ route('login') }}" method="post">
                        @csrf
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-xl @error('email') is-invalid @enderror"
                                placeholder="Username" name="email" autofocus autocomplete="off"
                                value="{{ old('email') }}">
                            @error('email')
